  ...
  return (
    ...
    <form action={formAction} className="space-y-6">
      ...
      <div className="space-y-2 group">
        <label htmlFor="name" className="block text-sm font-semibold text-slate-700 ml-1 transition-colors group-focus-within:text-[#1677ff]">文章标题</label>
        <div className="relative">
          <input type="text" id="title" name="title" required className="block w-full px-4 py-3.5 text-slate-700 bg-white/70 border border-[#d6e4ff] focus:ring-4 focus:ring-[#1677ff]/10 focus:border-[#1677ff] outline-none transition-all duration-300 placeholder-slate-400 disabled:opacity-50" placeholder="例如：如何提高工作效率" />
